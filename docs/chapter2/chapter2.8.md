...
- [Web前端开发测验](http://davidshariff.com/quiz/)

- [JavaScript Web测验](http://davidshariff.com/js-quiz/)
...
- [前端JavaScript最佳面试题（由一位前端工程师所编著的）](https://performancejs.com/post/hde6d32/The-Best-Frontend-JavaScript-Interview-Questions-(Written-by-a-Frontend-Engineer))
